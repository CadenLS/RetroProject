...
.proc update_player
  ...
  AND #PAD_L
  BEQ not_left  ; If Left button not pressed, skip
    LDX player_x
    DEX
    STX player_x
  not_left:
     AND #PAD_R
     BEQ not_right  ; If Right button not pressed, skip
       LDX player_x
       INX
       STX player_x
  not_right:
     AND #PAD_U
     BEQ not_up  ; If Up button not pressed, skip
       LDX player_y
       DEX
       STX player_y
  not_up:
     AND #PAD_D
     BEQ not_down  ; If Down button not pressed, skip
       LDX player_y
       INX
       STX player_y
  not_down:
